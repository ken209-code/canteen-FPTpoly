...
<body><jsp:include page="back_button.jsp" />    <div class="auth-container">
        <div class="auth-card">
            ...
            <div id="register" class="auth-tab-content">
                <div class="info-box">
                    ℹ️ Vui lòng điền đầy đủ thông tin để đăng kí tài khoản
                </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <% if (request.getAttribute("fieldError_username") != null) { %>
                                <div class="error-message" style="margin-top:8px; padding:8px; font-size:13px;"> <%= request.getAttribute("fieldError_username") %> </div>
                            <% } %>
                        </div>
                        <div class="form-group">
                            ...
                            <% if (request.getAttribute("fieldError_email") != null) { %>
                                <div class="error-message" style="margin-top:8px; padding:8px; font-size:13px;"> <%= request.getAttribute("fieldError_email") %> </div>
                            <% } %>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <% if (request.getAttribute("fieldError_fullName") != null) { %>
                                <div class="error-message" style="margin-top:8px; padding:8px; font-size:13px;"> <%= request.getAttribute("fieldError_fullName") %> </div>
                            <% } %>
                        </div>
                        <div class="form-group">
                            ...
                            <% if (request.getAttribute("fieldError_phone") != null) { %>
                                <div class="error-message" style="margin-top:8px; padding:8px; font-size:13px;"> <%= request.getAttribute("fieldError_phone") %> </div>
                            <% } %>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <% if (request.getAttribute("fieldError_password") != null) { %>
                                <div class="error-message" style="margin-top:8px; padding:8px; font-size:13px;"> <%= request.getAttribute("fieldError_password") %> </div>
                            <% } %>
                        </div>
                        <div class="form-group">
                            ...
                            <% if (request.getAttribute("fieldError_passwordConfirm") != null) { %>
                                <div class="error-message" style="margin-top:8px; padding:8px; font-size:13px;"> <%= request.getAttribute("fieldError_passwordConfirm") %> </div>
                            <% } %>
                        </div>
                    </div>
                        ...
                        <div class="form-row full">
                            <div class="form-group">
                                ...
                                <% if (request.getAttribute("fieldError_dateOfBirth") != null) { %>
                                    <div class="error-message" style="margin-top:8px; padding:8px; font-size:13px;"> <%= request.getAttribute("fieldError_dateOfBirth") %> </div>
                                <% } %>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row full">
                        <div style="margin-bottom: 15px; font-size: 12px; color: #6c757d;">
                            ...
                            <% if (request.getAttribute("fieldError_agreeTerms") != null) { %>
                                <div class="error-message" style="margin-top:8px; padding:8px; font-size:13px;"> <%= request.getAttribute("fieldError_agreeTerms") %> </div>
                            <% } %>
                            <label for="agree-terms">Tôi đồng ý với các điều khoản dịch vụ</label>
                        </div>
                    </div>

                    <button type="submit" class="btn btn-primary" style="width: 100%; margin-bottom: 15px;">Đăng kí</button>
