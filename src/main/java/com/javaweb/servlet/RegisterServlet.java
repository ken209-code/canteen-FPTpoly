...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            if (!validateRegistrationData(username, email, fullName, phone, password, passwordConfirm, agreeTerms, dateOfBirthStr, request, response)) {
                return;
            }

            boolean registrationSaved = saveCustomerAccount(username, email, fullName, phone, password, dateOfBirthStr, request);
    ...
    private boolean validateRegistrationData(String username, String email, String fullName, String phone,
                                            ...
                                            String dateOfBirthStr, HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {

        if (!ValidationUtil.isValidUsername(username)) {
            request.setAttribute("fieldError_username", "Tên đăng nhập phải có từ 3 ký tự và chỉ chứa chữ, số, -, _!");
            setRegistrationValues(request, username, email, fullName, phone, dateOfBirthStr);
            request.setAttribute("showRegisterTab", "true");
            request.getRequestDispatcher("/views/canteen/login.jsp").forward(request, response);
            return false;
        }
    ...
    private void setRegistrationValues(HttpServletRequest request, String username, String email, String fullName, String phone, String dateOfBirthStr) {
    ...
    private boolean saveCustomerAccount(String username, String email, String fullName, String phone,
                                       String password, String dateOfBirthStr, HttpServletRequest request) {
